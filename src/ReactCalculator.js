      ...
      for(var r = 0; r < inputButtons.length; r++){
        ...
        let inputRow = [];
         for(var i = 0; i < row.length; i++){
           let input = row[i];
           inputRow.push(<InputButton value={input} highlight={ this.state.selectSymbol === input} 
        ...
        return views;
            ...
            _handleStringInput(str){
              switch(str){
                ...
                case '-':
                case 'C':
                  this.setState({selectSymbol: str,
                  ...
                  break;
                  case '=':
                    let simbol = this.state.selectSymbol, inputValue = this.state.inputValue, previousInputValue = this.state.previousInputValue; 
